    ...
    <header>
      ...
      <div className="flex item-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          <div className="link">
            <p>Hello gurleen!!</p>
            <p className='font-extrabold md:text-sm'>nAccount nd lists</p>
          </div>
          <div className="link">
            <p>Returns</p>
          ...
          <div className="relative link flex items-center">
            <span className="absolute top-0 right-0 md:right-10 h-4 w-4 bg-yellow-400 rounded-full text-black text-center font-bold">{4}</span>
